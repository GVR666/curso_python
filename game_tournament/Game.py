...
def a_game():
    players_mex = ('piojo', 'chicharito', 'guardado', 'hector moreno', 'rafa marquez', 'salcido'
                   'vela','dos santos', 'herrera', 'layun', 'ochoa')
    players_arg = ('messi', 'di maria', 'lavezzi','higuain', 'enzo perez','mascherano','tagliafico','otamendi'
                   ,'zabaleta','romero','dibu')
